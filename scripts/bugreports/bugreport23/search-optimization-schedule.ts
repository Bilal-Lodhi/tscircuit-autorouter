...
function* generateSchedules(): Generator<{
  ...
  yield {
    ...
    schedule: [
      { SHUFFLE_SEED: 0, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 2 },
      { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 3 },
      { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 4 },
      { SHUFFLE_SEED: 3, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 5 },
      { SHUFFLE_SEED: 4, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 6 },
      { SHUFFLE_SEED: 5, CENTER_OFFSET_DIST_PENALTY_FACTOR: 1, EXPANSION_DEGREES: 8 },
    ],
  }

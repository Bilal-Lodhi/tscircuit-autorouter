...
function* generateSchedules(): Generator<{
  ...
  yield {
    ...
    schedule: [
      { SHUFFLE_SEED: 0, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 2, GREEDY_MULTIPLIER: 3 },
      { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 3, GREEDY_MULTIPLIER: 3 },
      { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 4, GREEDY_MULTIPLIER: 3 },
      { SHUFFLE_SEED: 3, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 5, GREEDY_MULTIPLIER: 3 },
    ],
  }
  ...
  for (const exp of [3, 4, 5]) {
    yield {
      ...
      schedule: [
        { SHUFFLE_SEED: 0, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: exp, GREEDY_MULTIPLIER: 3.5 },
        { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: exp, GREEDY_MULTIPLIER: 3.5 },
        { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: exp + 1, GREEDY_MULTIPLIER: 3.5 },
      ],
    }
  }
  ...
  yield {
    ...
    schedule: [
      { SHUFFLE_SEED: 0, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 3, GREEDY_MULTIPLIER: 3, NODE_PF_FACTOR: 30 },
      { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 3, GREEDY_MULTIPLIER: 3, NODE_PF_FACTOR: 30 },
      { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 4, GREEDY_MULTIPLIER: 3, NODE_PF_FACTOR: 30 },
    ],
  }
  ...
  yield {
    ...
    schedule: [
      ...
      { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 4, GREEDY_MULTIPLIER: 3 },
      { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 5, GREEDY_MULTIPLIER: 3 },
      { SHUFFLE_SEED: 3, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0, EXPANSION_DEGREES: 6, GREEDY_MULTIPLIER: 3 },
    ],
  }
  ...
  yield {
    ...
    schedule: [
      { SHUFFLE_SEED: 0, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0.5, EXPANSION_DEGREES: 3, GREEDY_MULTIPLIER: 3.5 },
      { SHUFFLE_SEED: 1, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0.5, EXPANSION_DEGREES: 3, GREEDY_MULTIPLIER: 3.5 },
      { SHUFFLE_SEED: 2, CENTER_OFFSET_DIST_PENALTY_FACTOR: 0.5, EXPANSION_DEGREES: 4, GREEDY_MULTIPLIER: 3.5 },
    ],
  }
}

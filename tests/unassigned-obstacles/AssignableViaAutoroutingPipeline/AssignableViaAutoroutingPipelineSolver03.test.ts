...
import { simpleRouteJson } from "../../../fixtures/unassigned-obstacles/AssignableViaAutoroutingPipelineSolver/AssignableViaAutoroutingPipelineSolver03.fixture" assert { type: "json" }

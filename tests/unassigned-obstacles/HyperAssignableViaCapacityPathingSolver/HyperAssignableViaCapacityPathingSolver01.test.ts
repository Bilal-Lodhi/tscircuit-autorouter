...
// @ts-ignore
import constructorInput from "../../../fixtures/unassigned-obstacles/AssignableViaCapacityPathingSolver_DirectiveSubOptimal/AssignableViaCapacityPathingSolver_DirectiveSubOptimal01.json" assert { type: "json" }

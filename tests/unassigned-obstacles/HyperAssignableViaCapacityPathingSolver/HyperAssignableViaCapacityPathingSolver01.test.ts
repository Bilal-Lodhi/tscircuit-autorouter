...
// @ts-ignore
import constructorInput from "../../../fixtures/unassigned-obstacles/AssignableViaCapacityPathingSolver_DirectiveSubOptimal/AssignableViaCapacityPathingSolver_DirectiveSubOptimal01.json" with { type: "json" }

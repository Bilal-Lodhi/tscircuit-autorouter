import cn310 from "fixtures/legacy/assets/cn310-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  ...
  const nodeWithPortPoints = cn310.nodeWithPortPoints as NodeWithPortPoints

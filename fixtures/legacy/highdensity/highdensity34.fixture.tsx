import cn62169 from "fixtures/legacy/assets/cn62169-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    <HyperHighDensityDebugger nodeWithPortPoints={cn62169.nodeWithPortPoints} />

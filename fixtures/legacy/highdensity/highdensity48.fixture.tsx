import cn22273 from "fixtures/legacy/assets/cn22273-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    // <HyperHighDensityDebugger nodeWithPortPoints={cn22273.nodeWithPortPoints} />

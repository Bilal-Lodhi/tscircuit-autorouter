import cn91158 from "fixtures/legacy/assets/cn91158-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    <HyperHighDensityDebugger nodeWithPortPoints={cn91158.nodeWithPortPoints} />

import cn8155 from "fixtures/legacy/assets/cn8155-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    <HyperHighDensityDebugger nodeWithPortPoints={cn8155.nodeWithPortPoints} />

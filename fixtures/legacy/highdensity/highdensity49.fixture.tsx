import cn37943 from "fixtures/legacy/assets/cn37943-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    <HyperHighDensityDebugger nodeWithPortPoints={cn37943.nodeWithPortPoints} />

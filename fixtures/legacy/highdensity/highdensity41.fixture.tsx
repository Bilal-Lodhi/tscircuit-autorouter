import cn1701 from "fixtures/legacy/assets/cn1701-nodeWithPortPoints.json" assert { type: "json" }
...
export default () => {
  return (
    <HyperHighDensityDebugger nodeWithPortPoints={cn1701.nodeWithPortPoints} />
